...
public abstract class AbstractVector implements IVector {
	...
	public IMatrix toColumnMatrix(boolean liveView) {
		return toRowOrColumnMatrix(liveView, false);
	}

	@Override
	public IMatrix toRowMatrix(boolean liveView) {
		return toRowOrColumnMatrix(liveView, true);
	}

	private IMatrix toRowOrColumnMatrix(boolean liveView, boolean rowMatrix) {
		IVector usedV;
		if (liveView) {
			usedV = this;
		} else {
		...
		return new MatrixVectorView(usedV, rowMatrix);
	}
