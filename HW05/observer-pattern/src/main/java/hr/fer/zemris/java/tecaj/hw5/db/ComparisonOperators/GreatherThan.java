 ...
 *
 */
public  class GreatherThan implements IComparisonOperator {

	/**
	 * Returns true if value1 for each element is greather than value2,false
	 * otherwise.
	 */
	@Override
